...
- **Enable gate**: `growth.enabled` (default true). When false, `/growthcheckin` and `/growthhistory` refuse with an ephemeral message. Admin `/growth set_channel` stays available.
