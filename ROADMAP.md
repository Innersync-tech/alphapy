# 🧬 Innersync • Alphapy Roadmap v3.15.0 "Reflection Loop"

**Current release: v3.15.0** 🤖 Alphapy Agents MVP shipped earlier (v3.9.0) — `/agent` for linked users, Supabase sessions/memory, safety policy, jailbreak-tested. This roadmap tracks work from that baseline forward.
